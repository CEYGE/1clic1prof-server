...
@Repository("TeacherSpecialityDAOImpl")
public class TeacherSpecialityDAOImpl implements TeacherSpecialityDAO {

    private JdbcTemplate template;

    @Autowired
    public TeacherSpecialityDAOImpl(JdbcTemplate template) {
