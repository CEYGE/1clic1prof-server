...
@Repository("StudentSchoolLevelDAOImpl")
public class StudentSchoolLevelDAOImpl implements StudentSchoolLevelDAO {

    private JdbcTemplate template;

    @Autowired
    public StudentSchoolLevelDAOImpl(JdbcTemplate template) {
